"""
Changes:
- SHIFT+A toggles edge/filtered view during draw mode
...
if __name__ == "__main__":
    ...
    imgPath = "C:/Users/LENOVO/Box/Summer 2022/InteractiveSurfaceBedPicker/Flight141_ZScopes/30_0005951_0005975-reel_begin_end.tiff"

    # base image:=========================
    # image = Image(imgPath, (0,824), DEBUG=DEBUG)
    image = Image(imgPath, cropVals=(460, 1780), DEBUG=DEBUG)

    # creating windows
    winRef = Window("Reference", drawable=True, detail=DETAIL, image=image.img, DEBUG=DEBUG)

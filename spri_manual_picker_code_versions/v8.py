"""
Changes:
- new CSV output file that show (x,y, pixel depth) 

BUGS:
- tweaking sliders after right-clicking produces undesirable results 

TODO:
- export averaged points to csv file
...
from copy import deepcopy               # comes with Python ; required for functionality
from itertools import zip_longest       # comes with Python ; required for functionality
...
from functools import partial           # comes with Python ; needed to make trackbar callbacks work
...
class PolygonDrawer():
    ...
    def createAvgLine(self, detail:int):
        ...
        #             whitePoints.append((x, y)) #add the point to and the array
        #             # print([y, x])
        # --------------


        # attempt 2-----
        # THIS IS ABOUT 10 SECS FASTER THAN "attempt 1"

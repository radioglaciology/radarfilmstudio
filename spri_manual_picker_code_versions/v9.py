"""
Changes:
- keyboard assignments replaced with correspoding sliders (undo, viewModes)
...
- tiff stitching after batch processing
...
class Window:
    ...
    def drawLines (self):
        ...
        if len(self.polyDrawerSurface.points) >= 3: # make sure there are enough points for create an avg line selection
            ...
            self.polyDrawerSurface.createAvgLine(detail=self.detail)
        ...
        if len(self.polyDrawerBed.points) >= 3: # make sure there are enough points for create an avg line selection
            ...
            self.polyDrawerBed.createAvgLine(detail=self.detail)
...
if __name__ == "__main__":
    ...
    path = "C:/Users/LENOVO/Desktop/testImages"
    # path = "C:/Users/LENOVO/Desktop/TIFFS"
    dir_list = os.listdir(path) # Get the list of all files and directories
